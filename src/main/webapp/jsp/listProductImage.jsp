...
<script>
    $(function () {
        $('.addFormSingle').submit(function () {
            if (checkEmpty("fileSinglePath", "图片文件")){
                $('#fileSinglePath').val('');
                return true;
            }
            return false;
        ...
        $('.addFormDetail').submit(function () {
            if (checkEmpty("fileDetailPath", "图片文件"))
                return true;
            return false;
        });
    });
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisSingle}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看原图" href="img/productSingle/${pi.id}.jpg"><img height="50px" src="resources/img/productSingle/${pi.id}.jpg"></a>
                                </td>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisDetail}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看原图" href="img/productDetail/${pi.id}.jpg"><img height="50px" src="resources/img/productDetail/${pi.id}.jpg"></a>
                                </td>
                                <td><a deleteLink="true"
                                       href="admin_productImage_delete?id=${pi.id}"><span
                                        class="     glyphicon glyphicon-trash"></span></a></td>
