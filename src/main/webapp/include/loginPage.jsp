...
<div id="loginDiv" style="position: relative">
    ...
    <div class="simpleLogo">
        <a href="${contextPage}"><img src="resources/img/site/simpleLogo.png"></a>
    </div>

    <img id="loginBackgroundImg" class="loginBackgroundImg" src="resources/img/site/loginBackground.png">
