...
<div class="boughtDiv">
    <div class="orderType">
        ...
        <div><a orderStatus="3" href="#nowhere" class="noRightborder">待评价</a></div>
        ...
        <c:forEach items="${os}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td  colspan="2"><img width="13px" src="resources/img/site/orderItemTmall.png">天猫商场</td>
                    <td colspan="1">
                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR" >
                        <td class="orderItemProductInfoPartTD"><img width="80" height="80" src="resources/img/productSingle_middle/${oi.product.firstProductImage.id}.jpg"></td>
